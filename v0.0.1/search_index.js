...

{
    ...
    "category": "section",
    "text": "This package provides tools for working with colorschemes and colormaps.You can extract color schemes from images, and replace an image\'s color scheme with another. There are also function for creating ColorSchemes from pre-defined lists or Julia functions.This package relies on:Colors.jl\nColorSchemes.jl\nImages.jl\nClustering.jland you might need image-capable software installed, such as ImageMagick.jl or QuartzImageIO."
},
...

{
    ...
    "category": "section",
    "text": "To make new ColorSchemes, you can build arrays of colors—see the ColorSchemes.jl documentation. You can also use the ColorSchemeTools function make_colorscheme(), and supply information about the color sequences you want. The following formats are possible:a dictionary of linear segments\nan \'indexed list\' of RGB values\nthree Julia functions that generate values between 0 and 1 for the RGB levels"
},
