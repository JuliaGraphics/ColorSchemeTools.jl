...

{
    ...
    "category": "section",
    "text": "There are a few functions that can make new ColorSchemes:make_linear_segment_colorscheme()\nmake_indexed_list_colorscheme()\nmake_functional_colorscheme()"
},
...

{
    ...
    "category": "section",
    "text": "A linearly-segmented color dictionary looks like this:hsvdict = Dict(:red => ((0., 1., 1.),\n                       (0.158730, 1.000000, 1.000000),\n                       (0.174603, 0.968750, 0.968750),\n                       (0.333333, 0.031250, 0.031250),\n                       (0.349206, 0.000000, 0.000000),\n                       (0.666667, 0.000000, 0.000000),\n                       (0.682540, 0.031250, 0.031250),\n                       (0.841270, 0.968750, 0.968750),\n                       (0.857143, 1.000000, 1.000000),\n                       (1.0, 1.0, 1.0)),\n             :green => ((0., 0., 0.),\n                       (0.158730, 0.937500, 0.937500),\n                       (0.174603, 1.000000, 1.000000),\n                       (0.507937, 1.000000, 1.000000),\n                       (0.666667, 0.062500, 0.062500),\n                       (0.682540, 0.000000, 0.000000),\n                       (1.0, 0., 0.)),\n             :blue =>  ((0., 0., 0.),\n                       (0.333333, 0.000000, 0.000000),\n                       (0.349206, 0.062500, 0.062500),\n                       (0.507937, 1.000000, 1.000000),\n                       (0.841270, 1.000000, 1.000000),\n                       (0.857143, 0.937500, 0.937500),\n                       (1.0, 0.09375, 0.09375)))The first number in each tuple for each color increases from 0 to 1, the second and third determine the color values. (TODO - how exactly?)To create a new ColorScheme from this, call make_linear_segment_colorscheme().using Colors, ColorSchemes\nscheme = make_linear_segment_colorscheme(hsvdict)Save an image of this:using ColorSchemes, FileIO\nimg = colorscheme_to_image(ColorScheme(scheme), 450, 60)\nsave(\"/tmp/linseg.png\", img)(Image: \"linear segmented colorscheme\")By plotting the color components separately it\'s possible to see how the curves change. This is what the hsv scheme looks like:draw_rgb_levels(ColorSchemes.hsv, 800, 200, \"assets/figures/hsvcurves.svg\") #hide\nnothing # hide(Image: \"hsv linear segmented colorscheme\")get_linear_segment_color"
},

{
    "location": "makingschemes.html#ColorSchemeTools.make_indexed_list_colorscheme",
    "page": "Making colorschemes",
    "title": "ColorSchemeTools.make_indexed_list_colorscheme",
    "category": "function",
    "text": "make_indexed_list_colorscheme(indexedlist, name::Symbol;\n    length=100)\n\nMake a colorscheme using an \'indexed list\' like this:\n\ngist_rainbow = (\n       (0.000, (1.00, 0.00, 0.16)),\n       (0.030, (1.00, 0.00, 0.00)),\n       (0.215, (1.00, 1.00, 0.00)),\n       (0.400, (0.00, 1.00, 0.00)),\n       (0.586, (0.00, 1.00, 1.00)),\n       (0.770, (0.00, 0.00, 1.00)),\n       (0.954, (1.00, 0.00, 1.00)),\n       (1.000, (1.00, 0.00, 0.75))\n)\n\nThe first element of this list of tuples is the point on the color scheme.\n\nmake_indexed_list_colorscheme(gist_rainbow)\n\n\n\n\n\n"
},
...

{
    ...
    "category": "section",
    "text": "The colors in a \'functional\' color scheme are produced by three functions that calculate the color values at each point on the scheme.The make_functional_colorscheme() function takes three functions and applies them at each point on the colorscheme.fscheme = make_functional_colorscheme(sqrt, sin, cos)\ndraw_rgb_levels(fscheme, 800, 200, \"assets/figures/funcschemecurves.svg\") # hide\nnothing # hide(Image: \"functional color schemes\")make_functional_colorscheme"
},
